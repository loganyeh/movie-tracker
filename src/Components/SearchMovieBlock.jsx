    ...
    return(
        <>
            {/* <div className="border-2 border-yellow-400 h-200 w-10/12 mb-10">
                ...
                <div className="min-h-96 w-10/12 mb-6">
                    ...
                    <div className="h-8 w-full flex mb-4">
                        <div className="h-full w-1/2 flex justify-start items-center text-lg text-gray-700 font-medium">
                            ...
                            <div className="h-10/12 w-1/6 flex justify-center items-center text-sm text-gray-100 font-semibold bg-blue-400 rounded-l cursor-pointer">
                                <span>Search: Query</span>
                            </div>
                            <div className="h-10/12 w-6 flex justify-center items-center bg-blue-400 rounded-r cursor-pointer"><i className='bx bx-x text-gray-100' ></i></div>
                        </div>
